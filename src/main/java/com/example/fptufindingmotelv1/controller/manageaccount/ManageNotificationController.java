...
public class ManageNotificationController {
    ...
    public JSONObject getNotifications(@RequestBody NotificationDTO request){
        ...
        List<NotificationModel> notificationModels = manageNotificationService.getListNotification(request);
    ...
    public JSONObject getNotificationNumber(@RequestBody NotificationDTO request){
        ...
        int notificationNumber = manageNotificationService.getNotificationNumber(request);
    ...
    public JSONObject changeStatusNotification(@RequestBody NotificationDTO request){
        ...
        NotificationModel notificationModel = manageNotificationService.changeStatusNotification(request);
